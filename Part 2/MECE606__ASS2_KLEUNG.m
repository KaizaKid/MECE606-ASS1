...
h.crosscorrelatesub = uicontrol('style','pushbutton','string','Cross Correlate (Sub-region)','Position',[25 305 150 20]);
...
h.crosscorrelatemouse = uicontrol('style','pushbutton','string','Cross Correlate (Mouse Selection)','Position',[75 285 200 20]);
...
for j = 1:1*winover:windown

    for i = 1:1*winover:wincross
